...
func (b *EthAPIBackend) AddPrivateTransaction(ctx context.Context, tx *types.Transaction, maxBlockNumber uint64) error {
	return b.eth.txPool.AddPrivateTransaction(tx, maxBlockNumber)
}
